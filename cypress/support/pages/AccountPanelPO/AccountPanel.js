import { accountDetails, passwordChange } from "../../locators/AccountPanelLocators";
...
class AccountPanel {
    accountDetails() {
        ...
        cy.get(head.header).invoke('text').then(header => {
        ...
        cy.get(successMsg.msg).invoke('text').then(text => {
